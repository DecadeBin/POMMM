...
# Fixed Matrix
# matrix_a = abs(torch.tile(torch.arange(-105, -105 + in1 * 10, 10).reshape(-1, 1), (1, in2)))
# matrix_b = abs(torch.tile(torch.arange(-105, -105 + out * 10, 10), (in2, 1)))
...
z = 400e-3  # Propagation distance (400 mm)
...
matrix_a_lp = torch.flip(matrix_a_lp, dims=[1])
matrix_a_cp = matrix_a_c * linear_phase # Phase modulation (All ones matrix)
matrix_a_cp = torch.flip(matrix_a_cp, dims=[1])

a_rate = 6 # Aperture expended rate
L_full = L * a_rate
...
lens_phase_1_1 = torch.exp(-1j * k * (Y**2) / (2 * z / 2))
lens_phase_2_1 = torch.exp(-1j * k * (X**2) / (2 * z / 2))
...
U_out1 = rayleigh_sommerfeld_2d(U_in, wavelength, z / 2, L_full)
U_out2 = rayleigh_sommerfeld_2d(U_out1 * lens_phase_2_1, wavelength, z / 2, L_full)
del U_out1
U_out2_2 = rayleigh_sommerfeld_2d(U_out2 * lens_phase_1, wavelength, z / 2, L_full)
del U_out2
U_out2_3 = rayleigh_sommerfeld_2d(U_out2_2 * lens_phase_2_1, wavelength, z / 2, L_full)
del U_out2_2
U_out3 = rayleigh_sommerfeld_2d(U_out2_3 * weight, wavelength, z / 2, L_full)
del U_out2_3
U_out4 = rayleigh_sommerfeld_2d(U_out3 * lens_phase_1_1, wavelength, z / 2, L_full)
del U_out3
U_out4_2 = rayleigh_sommerfeld_2d(U_out4 * lens_phase_2, wavelength, z / 2, L_full)
del U_out4
U_out4_3 = rayleigh_sommerfeld_2d(U_out4_2 * lens_phase_1_1, wavelength, z / 2, L_full)

U_out4_3 = torch.flip(U_out4_3, dims=[0])
del U_out4_2

U_out1_c = rayleigh_sommerfeld_2d(U_in_c, wavelength, z / 2, L_full)
U_out2_c = rayleigh_sommerfeld_2d(U_out1_c * lens_phase_2_1, wavelength, z / 2, L_full)
del U_out1_c
U_out2_2_c = rayleigh_sommerfeld_2d(U_out2_c * lens_phase_1, wavelength, z / 2, L_full)
del U_out2_c
U_out2_3_c = rayleigh_sommerfeld_2d(U_out2_2_c * lens_phase_2_1, wavelength, z / 2, L_full)
del U_out2_2_c
U_out3_c = rayleigh_sommerfeld_2d(U_out2_3_c * weight_c, wavelength, z / 2, L_full)
del U_out2_3_c
U_out4_c = rayleigh_sommerfeld_2d(U_out3_c * lens_phase_1_1, wavelength, z / 2, L_full)
del U_out3_c
U_out4_2_c = rayleigh_sommerfeld_2d(U_out4_c * lens_phase_2, wavelength, z / 2, L_full)
del U_out4_c
U_out4_3_c = rayleigh_sommerfeld_2d(U_out4_2_c * lens_phase_1_1, wavelength, z / 2, L_full)

U_out4_3_c = torch.flip(U_out4_3_c, dims=[0])
del [U_out4_2_c]

# Compute intensity
I_out = torch.abs(U_out4_3)
del [U_out4_3]
I_out_a = I_out.numpy()

I_out_c = torch.abs(U_out4_3_c)
del [U_out4_3_c]
