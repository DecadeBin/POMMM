...
from Huygens_Fresnel_Diffraction import huygens_fresnel_2d  # Import the diffraction function
...
rep_temp = torch.ones(rep2, in2 * rep)
...
U_out1 = huygens_fresnel_2d(U_in, wavelength, z / 2, L_full)
U_out2 = huygens_fresnel_2d(U_out1 * lens_phase_2_1, wavelength, z / 2, L_full)
U_out2_2 = huygens_fresnel_2d(U_out2 * lens_phase_1, wavelength, z / 2, L_full)
U_out2_3 = huygens_fresnel_2d(U_out2_2 * lens_phase_2_1, wavelength, z / 2, L_full)
U_out3 = huygens_fresnel_2d(U_out2_3 * weight, wavelength, z / 2, L_full)
U_out4 = huygens_fresnel_2d(U_out3 * lens_phase_1_1, wavelength, z / 2, L_full)
U_out4_2 = huygens_fresnel_2d(U_out4 * lens_phase_2, wavelength, z / 2, L_full)
U_out4_3 = huygens_fresnel_2d(U_out4_2 * lens_phase_1_1, wavelength, z / 2, L_full)

U_out4_3 = torch.flip(U_out4_3, dims=[0])
del [U_out1,U_out2,U_out2_2,U_out2_3,U_out3,U_out4,U_out4_2]

U_out1_c = huygens_fresnel_2d(U_in_c, wavelength, z / 2, L_full)
U_out2_c = huygens_fresnel_2d(U_out1_c * lens_phase_2_1, wavelength, z / 2, L_full)
U_out2_2_c = huygens_fresnel_2d(U_out2_c * lens_phase_1, wavelength, z / 2, L_full)
U_out2_3_c = huygens_fresnel_2d(U_out2_2_c * lens_phase_2_1, wavelength, z / 2, L_full)
U_out3_c = huygens_fresnel_2d(U_out2_3_c * weight_c, wavelength, z / 2, L_full)
U_out4_c = huygens_fresnel_2d(U_out3_c * lens_phase_1_1, wavelength, z / 2, L_full)
U_out4_2_c = huygens_fresnel_2d(U_out4_c * lens_phase_2, wavelength, z / 2, L_full)
U_out4_3_c = huygens_fresnel_2d(U_out4_2_c * lens_phase_1_1, wavelength, z / 2, L_full)

U_out4_3_c = torch.flip(U_out4_3_c, dims=[0])
del [U_out1_c,U_out2_c,U_out2_2_c,U_out2_3_c,U_out3_c,U_out4_c,U_out4_2_c]
